...
# Here, we use ratings on emotion regulation strategies 
# repeatedly reported by multiple persons as the example dataset
...
# results should be the same as (1)
  data.frame(ppname,calcBrayCurtisESM(dfLongToWide, varNameManual,varUniqueID[1],varUniqueID[2], bSubnarm = allowSub.na.rm, bPersonnarm = allowPerson.na.rm))
